//DEPS io.quarkus:quarkus-bom:${quarkus.version:2.1.2.Final}@pom
...
public class qdevservice {

    private static final Logger LOGGER = Logger.getLogger(qdevservice.class.getName());
    ...
    @Entity
@Cacheable
public static class Fruit extends PanacheEntity {
